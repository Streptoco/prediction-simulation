...
//            engine.reRunSimulation(simID0);
            /** Entity Property Histogram **/
            Map<String, Integer> histogram = engine.GetHistogram("Sick", "age", simID0);
            for (Map.Entry<String, Integer> entry : histogram.entrySet()) {
                String key = entry.getKey();
                Integer value = entry.getValue();
                System.out.println("Value: " + key + ", Amount: " + value);
            }
//            System.out.println(engine.averageValueOfProperty("Sick", "age", simID1));
